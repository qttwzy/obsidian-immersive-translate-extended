...
The 4.0.x public beta supports Obsidian Desktop 1.12.7 or newer, Markdown Reading View translation, and the official PDF/document translation workspace. Plugin settings show the locally installed runtime and current official version, with install and update actions from the official source.
...
3. Reproduce in the relevant Markdown Reading View or active PDF view on the latest published beta. For a missing PDF action, reload Obsidian or disable and re-enable the plugin after replacing its files.
